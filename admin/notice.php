	...
	<body>
		...
		<div class="col-lg-8">
			<div class="page-header"> <h1>Add Notice   </h1> </div>
				...
				<form class="form-horizontal" enctype="multipart/form-data" action="notice.php" method="post">
		...
		<?php 
			if (isset($_POST['submit'])) {
				...
				$sql= "INSERT INTO notices (notice_title,banner,description) 
									 ...
									 while ($rows= mysqli_fetch_array($run_sql)) { 
									 		echo' 
										 		 <tbody>
													...
													<td>  <img src="../images/'.$rows['banner'].'" width="120px"> </td>
